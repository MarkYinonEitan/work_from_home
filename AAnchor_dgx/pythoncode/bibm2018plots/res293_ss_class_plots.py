...
RES1 = SingleNetResults(NETS_FOLDER+'/v4_db2325simcorners/', LabelbyAAType.get_labels_to_names_dict())
RES1.load_data()

RES2 = SingleNetResults(NETS_FOLDER+'/v4_db2729simcorners/', LabelbyAAType.get_labels_to_names_dict())
RES2.load_data()


RES3 = SingleNetResults(NETS_FOLDER+'/v4_db2931simcorners/', LabelbyAAType.get_labels_to_names_dict())
RES3.load_data()
...
plot_total_accuracy3([RES1.det_acc_per_epoch[-1],RES2.det_acc_per_epoch[-1],RES3.det_acc_per_epoch[-1]],['Res $2.2 \\AA$','Res $2.9 \\AA$','Res $3.1 \\AA$'], RES1.labels_names,labels_to_show,'Train: Sim, Test Sim',RES_FOLDER+'s3_293_acc.png')
