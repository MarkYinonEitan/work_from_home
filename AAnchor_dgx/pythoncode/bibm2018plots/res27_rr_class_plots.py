...
RES = SingleNetResults(NETS_FOLDER+'/v4_db2729_real_rot10/', LabelbyAAType.get_labels_to_names_dict())
RES.load_data()
plot_detection_matrix(RES.det_matrix, '',RES.labels, RES.names, RES_FOLDER+'CM_29_RR.png')
...
plot_reliability_curve(RES.prob_vs_output[20],'VAL',RES_FOLDER+'rel_VAL_29_RR.png')
plot_reliability_curve(RES.prob_vs_output[8],'GLY',RES_FOLDER+'rel_GLY_29_RR.png')
plot_reliability_curve(RES.prob_vs_output[15],'PRO',RES_FOLDER+'rel_PRO_29_RR.png')
plot_reliability_curve(RES.prob_vs_output[11],'LEU',RES_FOLDER+'rel_LEU_29_RR.png')
