...
res_folder = data_folder + '/nets_data/cnn_3A_norm01/'

NETWORK_MODEL = data_folder + '/nets_data/cnn_3A_var_apix/mod9.json'
WEIGHTS_INITIAL = data_folder + '/nets_data/cnn_3A_var_apix/mod9.h5'
DATABASE_FOLDER =  data_folder +'/rotamersdata/DB_res30apix-1norm01/'
...
json_file = open(NETWORK_MODEL, 'r')
