...
TEST_PDB_FILE = dir_path +'/../../data//cryoEM/raw_data/res2931/5gaq.pdb'
TEST_REAL_MAP_FILE = dir_path +'/../../data//cryoEM/raw_data/res2931/emd-8015.mrc'
TEST_SIM_MAP_FILE = dir_path +'/../../data//cryoEM/raw_data/res2931_mrc/5gaq_res30apix14.mrc'


TEST_SIM_BOXES = BASE_FOLDER + 'emd_8015_pdb_5gaq_sim.pkl.gz'
network = all_nets.V5_no_reg()
TEST_REAL_BOXES = BASE_FOLDER + 'emd_8015_pdb_5gaq_real.pkl.gz'
network = all_nets.V5_no_reg()


net1={}
net1["name"] = "Train: Sim Rotamers, Test: Sim 8015"
net1["nets"] = []
...
net2={}
net2["name"] = "Train: Sim Rotamers, Test: Real 8015"
net2["nets"] = []
...
net3={}
net3["name"] = "Train: Real Maps, Test: Real 8015"
net3["nets"] = []
...
net4={}
net4["name"] = "Train: Real Maps+Sim Rotamers, Test: Real 8015"
net4["nets"] = []
...
net5={}
net5["name"] = "Mean of Three, Test: Real 8015"
net5["nets"] = []
...
net7={}
net7["name"] = "Majority of Three, Test: Real 8015"
net7["nets"] = []
