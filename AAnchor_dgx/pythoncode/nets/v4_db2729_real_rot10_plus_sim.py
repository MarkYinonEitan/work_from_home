...
N_epoch = 50
mini_epochs = 5
pdbs_per_mini_epoch=150

data_folder = dir_path +'/../../data/'
NETS_FOLDER = data_folder+'/nets_data/'
RES_FOLDER = NETS_FOLDER+'/v4_db2729_real_rot10_plus_sim/'
DATABASE_FOLDER =  data_folder +'/cryoEM/DB2729class_rot10/'
SIM_DATABASE_FOLDER =  data_folder +'/rotamersdata/DB2729simcorners/'
WEIGHTS_INITIAL = RES_FOLDER+'/weights_updated.h5'
LABELELING = LabelbyAAType
REAL_TO_SIM_FACTOR =2
NETWORK = all_nets.V5_no_reg()

train_emds = ['3246','8574','7300','8761','8189','8604','7452','6741']
valid_emds = ['6224']
