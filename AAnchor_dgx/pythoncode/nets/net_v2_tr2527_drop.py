...
res_folder = data_folder + '/nets_data/net_v2_tr2527_drop/'

OPTIMIZER = 'adagrad'
WEIGHTS_INITIAL = data_folder + '/nets_data/net_v2_tr2325_drop/mod19.h5'
DATABASE_FOLDER =  data_folder +'/rotamersdata/DBres2527norm01/'
