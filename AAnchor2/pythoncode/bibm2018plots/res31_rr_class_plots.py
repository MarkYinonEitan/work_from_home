...
RES = SingleNetResults(NETS_FOLDER+'/v4_db2931_real_rot10/', LabelbyAAType.get_labels_to_names_dict())
RES.load_data()
plot_detection_matrix(RES.det_matrix, '',RES.labels, RES.names, RES_FOLDER+'CM_31_RR.png')

plot_det_vs_datasize(RES.det_acc_per_epoch[-1],RES.train_data_stat, RES.labels_names, '',  RES_FOLDER+'DS_31_RR.png')
plot_det_vs_datasize_norm(RES.det_acc_per_epoch[-1],RES.train_data_stat, RES.labels_names, '',  RES_FOLDER+'DS_norm_31_RR.png')

#plot_total_accuracy(RES.det_acc_per_epoch[-1], RES.labels_names,labels_to_show,'Res: $2.2$,  Train: Exp. Data , Test: $\\beta$-galactosidase,EMD-2984. ',RES_FOLDER+'rr22_acc.png')


plot_reliability_curve(RES.prob_vs_output[20],'VAL',RES_FOLDER+'rel_VAL_31_RR.png')
plot_reliability_curve(RES.prob_vs_output[8],'GLY',RES_FOLDER+'rel_GLY_31_RR.png')
plot_reliability_curve(RES.prob_vs_output[15],'PRO',RES_FOLDER+'rel_PRO_31_RR.png')
plot_reliability_curve(RES.prob_vs_output[11],'LEU',RES_FOLDER+'rel_LEU_31_RR.png')
