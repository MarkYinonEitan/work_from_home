...
RES_FOLDER = NETS_FOLDER+'/v4_db2931_real_rot10_plus_sim/'
DATABASE_FOLDER =  data_folder +'/cryoEM/DB2931class_rot10/'
SIM_DATABASE_FOLDER =  data_folder +'/rotamersdata/DB2931simcorners/'
