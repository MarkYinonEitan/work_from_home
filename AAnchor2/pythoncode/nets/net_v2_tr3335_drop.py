...
res_folder = data_folder + '/nets_data/net_v2_tr3335_drop/'

OPTIMIZER = 'adagrad'
WEIGHTS_INITIAL = data_folder + '/nets_data/net_v2_tr3133_drop/mod19.h5'
DATABASE_FOLDER =  data_folder +'/rotamersdata/DBres3335norm01/'
