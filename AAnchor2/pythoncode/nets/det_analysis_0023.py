...
BASE_FOLDER = NETS_FOLDER+'/det_analysis_0023/'
SUM_FOLDER =  BASE_FOLDER + '/sum_all_nets/'
network = all_nets.V5_no_reg()

net1={}
net1["name"] = "Train: Sim Rotamers, Test: Sim 2984"
net1["nets"] = []
net1["nets"].append({"model": network.get_compiled_net(), "weights_file":NETS_FOLDER+'/v4_db2325simcorners/weights_updated.h5'})
net1["consensus"] = MeanProbConsensus()
net1["res_folder"] = BASE_FOLDER+'/train_full_sim_test_sim/'
net1["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023_aug10_mrc/5a1a.pdb'
net1["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023_aug10_mrc/5a1a_res21apix10.mrc'
net1["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_sim.pkl.gz'
net1["labeling"] = LabelbyAAType
net1["labels_to_print"] = [[x] for x in range(21)]+[[15,2,11,14]]


net2={}
net2["name"] = "Train: Sim Rotamers, Test: Real 2984"
net2["nets"] = []
net2["nets"].append({"model": network.get_compiled_net(), "weights_file":NETS_FOLDER+'/v4_db2325simcorners/weights_updated.h5'})
net2["consensus"] = MeanProbConsensus()
net2["res_folder"] = BASE_FOLDER+'/train_full_sim_test_real/'
net2["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net2["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net2["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
net2["labeling"] = LabelbyAAType
net2["labels_to_print"] = [[x] for x in range(21)]+[[15,2,11,14]]


net3={}
net3["name"] = "Train: Real Maps, Test: Real 2984"
net3["nets"] = []
net3["nets"].append({"model": network.get_compiled_net(), "weights_file":NETS_FOLDER+'/v4_db0023_real_rot10/weights_updated.h5'})
net3["consensus"] = MeanProbConsensus()
net3["res_folder"] = BASE_FOLDER+'/train_real_test_real/'
net3["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net3["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net3["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
net3["labeling"] = LabelbyAAType
net3["labels_to_print"] = [[x] for x in range(21)]+[[15,2,11,14]]


net4={}
net4["name"] = "Train: Real Maps+Sim Rotamers, Test: Real 2984"
net4["nets"] = []
net4["nets"].append({"model": network.get_compiled_net(), "weights_file": NETS_FOLDER+'/v4_db0023_real_rot10_plus_sim/weights_updated.h5'})
net4["consensus"] = MeanProbConsensus()
net4["res_folder"] = BASE_FOLDER+'/train_real_sim_test_real/'
net4["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net4["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net4["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
net4["labeling"] = LabelbyAAType
net4["labels_to_print"] = [[x] for x in range(21)]+[[15,2,11,14]]

net5={}
net5["name"] = "Mean of Three, Test: Real 2984"
net5["nets"] = []
...
net5["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net5["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net5["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
...
net6={}
net6["name"] = "Mean of Real + Sim, Test: Real 2984"
net6["nets"] = []
...
net6["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net6["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net6["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
net6["labeling"] = LabelbyAAType
net6["labels_to_print"] = [[x] for x in range(21)]+[[15,2,11,14]]

net7={}
net7["name"] = "Majority of Three, Test: Real 2984"
net7["nets"] = []
...
net7["test_pdb_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/5a1a.pdb'
net7["test_mrc_file"] = dir_path +'/../../data//cryoEM/raw_data/res0023/emd-2984.map'
net7["test_boxes_file"] = BASE_FOLDER + 'emd_2984_pdb_5a1a_real.pkl.gz'
