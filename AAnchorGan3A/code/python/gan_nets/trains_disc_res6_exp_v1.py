...
all_data = EM_DATA_REAL_SYTH(data_fld,real_pdbs = real_pdbs[:4],synth_pdbs =syn_pdbs[:4], is_random = True)
...
em_test = EM_DATA_DISC_RANDOM(data_fld,train_pdbs=syn_pdbs[21:23])
    ...
    for epoch_num in range(N_EPOCHS):
        ...
        for batch in range(all_data.N_batches-1):
            ...
            if batch % 10 == 0:
                ...
                format(epoch_num,N_EPOCHS,batch,all_data.N_batches,time_end - time_start,BATCH_SIZE,' 4 GPUS'))
                time_start = timer()
