...
res_folder = data_folder + '/nets_data/cnn_3A_var_apix/'
initial_weights_file = res_folder + '/weights_20epochs.pkl.gz'
...
## the network
model = Sequential()
model.add(Conv3D(20, (2,2,2),input_shape=(11,11,11,1)))
...
reslts = SingleNetResults(res_folder, l2n,res_per_epoch=res_data, valid_data=valid_data)
reslts.save_data()
reslts.load_data()
