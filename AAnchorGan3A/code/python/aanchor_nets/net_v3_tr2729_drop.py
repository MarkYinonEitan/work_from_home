...
res_folder = data_folder + '/nets_data/net_v3_tr2729_drop/'

OPTIMIZER = 'adagrad'
WEIGHTS_INITIAL = data_folder + '/nets_data/net_v3_tr2527_drop/mod19.h5'
DATABASE_FOLDER =  data_folder +'/rotamersdata/DBres2729norm01/'
