...
res_folder = data_folder + '/nets_data/net_v2_tr2325_drop/'

OPTIMIZER = 'adagrad'
WEIGHTS_INITIAL = data_folder + '/nets_data/net_v2_tr2325/mod19.h5'
DATABASE_FOLDER =  data_folder +'/rotamersdata/DBres2325norm01/'
