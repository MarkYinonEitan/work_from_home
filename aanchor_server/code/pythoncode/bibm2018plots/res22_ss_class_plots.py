...
RES22_s_s = SingleNetResults(NETS_FOLDER+'/v4_db2325simcorners/', LabelbyAAType.get_labels_to_names_dict())
RES22_s_s.load_data()
plot_detection_matrix(RES22_s_s.det_matrix, '',RES22_s_s.labels, RES22_s_s.names, RES_FOLDER+'CM_22_SS.png')

plot_det_vs_datasize(RES22_s_s.det_acc_per_epoch[-1],RES22_s_s.train_data_stat, RES22_s_s.labels_names, '',  RES_FOLDER+'DS_22_SS.png')
plot_det_vs_datasize_norm(RES22_s_s.det_acc_per_epoch[-1],RES22_s_s.train_data_stat, RES22_s_s.labels_names, '',  RES_FOLDER+'DS_norm_22_SS.png')

plot_reliability_curve(RES22_s_s.prob_vs_output[1],'ALA',RES_FOLDER+'rel_ALA_22_SS.png')
plot_reliability_curve(RES22_s_s.prob_vs_output[2],'ARG',RES_FOLDER+'rel_ARG_22_SS.png')
plot_reliability_curve(RES22_s_s.prob_vs_output[15],'PRO',RES_FOLDER+'rel_PRO_22_SS.png')
plot_reliability_curve(RES22_s_s.prob_vs_output[11],'LEU',RES_FOLDER+'rel_LEU_22_SS.png')
plot_total_accuracy(RES22_s_s.det_acc_per_epoch[-1], RES22_s_s.labels_names,labels_to_show,'Res: $2.2$,  Train:  Sim, Test: Sim',RES_FOLDER+'ss22_acc.png')
...
RES22_r_r = SingleNetResults(NETS_FOLDER+'/v4_db0023_real_rot10/', LabelbyAAType.get_labels_to_names_dict())
RES22_r_r.load_data()
plot_detection_matrix(RES22_r_r.det_matrix, '',RES22_r_r.labels, RES22_r_r.names, RES_FOLDER+'CM_22_RR.png')

plot_det_vs_datasize(RES22_r_r.det_acc_per_epoch[-1],RES22_r_r.train_data_stat, RES22_r_r.labels_names, '',  RES_FOLDER+'DS_22_RR.png')
plot_det_vs_datasize_norm(RES22_r_r.det_acc_per_epoch[-1],RES22_r_r.train_data_stat, RES22_r_r.labels_names, '',  RES_FOLDER+'DS_norm_22_RR.png')
plot_reliability_curve(RES22_r_r.prob_vs_output[1],'ALA',RES_FOLDER+'rel_ALA_22_RR.png')
plot_reliability_curve(RES22_r_r.prob_vs_output[2],'ARG',RES_FOLDER+'rel_ARG_22_RR.png')
plot_reliability_curve(RES22_r_r.prob_vs_output[15],'PRO',RES_FOLDER+'rel_PRO_22_RR.png')
plot_reliability_curve(RES22_r_r.prob_vs_output[11],'LEU',RES_FOLDER+'rel_LEU_22_RR.png')
