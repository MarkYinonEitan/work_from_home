...
res_folder = data_folder + '/nets_data/cnn_3A_norm01drop2/'


OPTIMIZER = 'rmsprop' # not good for seq with Dropout
OPTIMIZER = 'adagrad'
WEIGHTS_INITIAL = data_folder + '/nets_data/cnn_3A_norm01_2/mod4.h5'
