...
data_folder = dir_path +'/../../data/cryoEM/DB0023classnoaug/'
nets_folder = dir_path +'/../../data/nets_data/'
res_folder = nets_folder+'/DB0023classnoaug_v3/'

train_data_files = ['DBfrom_emd-8194.pkl.gz','DBfrom_emd-3295.pkl.gz']
valid_data_file = 'DBfrom_emd-2984.pkl.gz'
...
# load data - train
td_boxes,td_centers,td_labels,td_orientations,td_mrc_files,td_pdb_files = load_6tuple_data([data_folder+x for  x in train_data_files])
